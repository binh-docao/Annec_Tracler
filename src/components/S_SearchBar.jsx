...
const locations = [
  { name: 'Berk(Home)', latitude: 30.599423632596523, longitude: -96.3357676885901 },
  { name: 'The Rec', latitude: 30.607091153547522, longitude: -96.34282303069187 },
  { name: 'Northgate', latitude: 30.61685584662688, longitude: -96.34748674633754 },
  { name: 'Work', latitude: 30.668269692474414, longitude: -96.33964056243526},
  { name: 'Drews', latitude: 30.611920513612297, longitude: -96.3135985205223}
];
...
const S_SearchBar = () => {
  ...
  return (
    <div className="bg-black">
      ...
      {showComponent ? (
        <center>
          <img src={require('./syd.jpg')} alt="Location Image" style={{ marginLeft: '10px', width: '300px', height: '400px' }} />
        </center>
      ) : null}
      {showComponent ? (
