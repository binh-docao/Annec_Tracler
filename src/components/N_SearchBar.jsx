...
const locations = [
  { name: 'Gotham City', latitude: 41.87941004355807, longitude: -87.62774165922237 },
];
...
const N_SearchBar = () => {
  ...
  return (
    <div className="bg-black">
      ...
      {showComponent ? (
        <center>
          <img src={require('./nico-high.jpg')} alt="Location Image" style={{ marginLeft: '10px', width: '300px', height: '400px' }} />
        </center>
      ) : null}
      {showComponent ? (
